    ...
    return (
        <section className="max-w-6xl mx-auto px-4 py-16">
            ...
            <div className="mb-16 border-b border-neutral-200 pb-10 pt-18">
                <h1 className="text-3xl md:text-4xl font-semibold text-title mb-4">Звʼяжіться з нами</h1>
                <p className="max-w-3xl text-text leading-relaxed opacity-80">Ми відкриті до взаємодії з тими, хто поділяє принципи відповідальності, державного мислення та дії. Запит — це початок розмови.</p>
            </div>
            {/* MAIN GRID */}
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                {/* LEFT: CONTACT FORM */}
                <div className="lg:col-span-2">
                    <h2 className="text-xl font-semibold mb-6">Форма звернення</h2>
                    <div className="bg-white border border-neutral-200 rounded-xl p-8">
                        {state.succeeded ? (
                            <div className="p-6 rounded-lg bg-emerald-50 border border-emerald-200">
                                <h3 className="font-semibold text-emerald-700 mb-2">Запит надіслано</h3>
                                <p className="text-sm text-emerald-700 opacity-80">Дякуємо. Ми розглянемо ваше звернення та звʼяжемося з вами.</p>
                            </div>
                        ) : (
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                {/* Topic */}
                                <div>
                                    <label className="block text-sm font-medium mb-1">Тема звернення</label>
                ...
                <aside className="space-y-8">
                    <div className="bg-neutral-50 border border-neutral-200 rounded-xl p-6">
                        ...
                        <p className="text-sm leading-relaxed opacity-80">Лідери, ветерани, аналітики, ініціативи та партнери, які працюють з майбутнім оборонної держави.</p>
                    </div>
                    <div className="bg-neutral-50 border border-neutral-200 rounded-xl p-6">
                        <h3 className="font-semibold mb-3">Принцип взаємодії</h3>
                        <p className="text-sm leading-relaxed opacity-80">Ми відповідаємо на запити, що мають зміст, відповідальність та довгострокову перспективу.</p>
                    </div>
                </aside>
            </div>
        </section>
