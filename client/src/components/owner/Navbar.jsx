...
const Navbar = () => {
    ...
    return (
        ...
        text-gray-500 border-b border-borderColor relative transition-all'>
            ...
            <Logo />
            {/* profile */}
            <p className='max-md:hidden text-right text-sm text-slate-600 tracking-wide'>Бажаємо здоров'я,  <span className="font-medium text-slate-800">{user?.full_name || "Учасник"}</span></p>
            {/* logout */}
